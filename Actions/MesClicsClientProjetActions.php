...
class MesClicsClientProjetActions{
    public static function creation(Projet $projet){
    ...
    public static function update(Projet $before_update, Projet $after_update){
    ...
    public static function removal(Projet $projet){
    ...
    public static function attachment(Projet $projet, Contrat $contrat){
    ...
    public static function detachment(Projet $projet, Contrat $contrat){
